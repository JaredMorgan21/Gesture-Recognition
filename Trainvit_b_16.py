...
if __name__ == "__main__":
    ...
    vit_b_16 = vit_b_16(weights=ViT_B_16_Weights.IMAGENET1K_V1).to(device)
    ...
    optimizer = torch.optim.Adam(vit_b_16.parameters(), lr=learning_rate)
    ...
    for t in range(epochs):
        print(f"Epoch {t+1}\n-------------------------------")
        train(train_dataloader, vit_b_16, loss_fn, optimizer)
        test(test_dataloader, vit_b_16, loss_fn)
    print("Done!")

    torch.save(vit_b_16.state_dict(), "vit_b_16.pth")
    print("Saved PyTorch Model State to vit_b_16.pth")